...
const MANUAL_SUPPLEMENTS = [
  ...
  {
    file: "boss-zhike-柯洛罗-地狱.md",
    id: "local-boss-zhike-keluoluo-diyu",
    title: "诡饲鸦主·柯洛罗（地狱）",
    kind: "system_rule",
    subtype: "zhike_boss_mechanics",
    parts: ["02_游戏系统规则", "03_副本规则", "01_智壳副本"],
    reason: "手工补充的凶影追缉智壳副本柯洛罗地狱难度 Boss 机制、技能与配装建议",
  },
  {
    file: "boss-zhike-柯洛罗-炼狱.md",
    id: "local-boss-zhike-keluoluo-lianyu",
    title: "诡饲鸦主·柯洛罗（炼狱）",
    kind: "system_rule",
    subtype: "zhike_boss_mechanics",
    parts: ["02_游戏系统规则", "03_副本规则", "01_智壳副本"],
    reason: "手工补充的凶影追缉智壳副本柯洛罗炼狱难度 Boss 机制、技能与配装建议",
  },
  {
    file: "boss-zhike-柯洛罗-修罗.md",
    id: "local-boss-zhike-keluoluo-shura",
    title: "诡饲鸦主·柯洛罗（修罗）",
    kind: "system_rule",
    subtype: "zhike_boss_mechanics",
    parts: ["02_游戏系统规则", "03_副本规则", "01_智壳副本"],
    reason: "手工补充的凶影追缉智壳副本柯洛罗修罗难度 Boss 机制、技能与配装建议",
  },
  {
